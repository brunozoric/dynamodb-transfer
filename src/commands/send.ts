...
export const runSend = async (sourcePath: string, table: ResolvedTable): Promise<void> => {
...
const sendJson = async (client: Client, tableName: string, sourcePath: string): Promise<void> => {
...
const sendNdjson = async (client: Client, tableName: string, sourcePath: string): Promise<void> => {
